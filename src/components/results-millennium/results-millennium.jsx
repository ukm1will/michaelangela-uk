...
class ResultsMillennium extends Component {
    state = {
        results: [],
    ...
    render() {
        ...
        return (
            <>
                <LinkToHomepage />
                <PageHeader dataTestId='competition-title' pageTitle={"Millennium Cup " + this.state.metadata.competitionYear} />
...
export default ResultsMillennium;